    ...
    return this.each(function() {
        ...
        */
        function drawLinks() {
            ...
            //新增输入跳转           
            if(numPages()>1 && opts.is_show_skip_page){
                jQuery("<i class='pl10'> 跳转到：</i><input type='text' size='3'class='pageNum' id='checkPageNum' value='"+(current_page+1)+"'>").appendTo(panel); 
                var btn = jQuery("<a href='#'>确定</a>")
