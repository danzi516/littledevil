...
<div class="console-container">
        ...
        <div class="col-sm-12">
            <div class="console-title clearfix">
                <div class="pull-left"><a href="javascript:" class="btn btn-default">商户管理</a> </div>
            </div>
            <hr/>
	 <div id="toolbar">
...
<script>
    ...
    function getCompanyList(params){
    	var url="${webRoot}/companyInfo/selectByPage";
    ...
    function resetPassword(row){
    	if(confirm("您确定要重置用户:"+row.companyName+" 的密码吗?"))
		{
    ...
    function deleteUser(row){
    	if(confirm("您确定要删除用户:"+row.companyName+" 吗?"))
		{
    ...
    function enableUser(row){
    	if(confirm("您确定要启用用户:"+row.companyName+" 吗?"))
		{
    ...
    function disableUser(row){
    	if(confirm("您确定要禁用用户:"+row.companyName+" 吗?"))
		{
	    	var url="${webRoot}/user/updateStatus";
	    	var data={
	    		"id":row.id,
