    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="console-title clearfix">
                <div class="pull-left"> <h5>个人用户修改</h5></div>
...
<script>
    $(document).ready(function() {
		...
		$("#phone").val("${userInfo.user.phone}");
		$("#state").val("${userInfo.user.state}");
		if("${userInfo.saleState}"=="1"){
			$("#saleState").attr("checked", true);
		};
    	//getRoleList();  这里先屏蔽掉  
        //改变复选框与单选框的样式
