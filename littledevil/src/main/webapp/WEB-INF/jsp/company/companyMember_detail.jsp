                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="userName" name="userName" value="${userInfo.user.userName}" class="form-control" readonly="readonly" placeholder="">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="ucName" name="ucName" value="${userInfo.ucName}" class="form-control" maxlength="25">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">手机 ：</label>
                            <div class="col-sm-4">
                                <input type="text" id="phone" name="phone" value="${userInfo.user.phone}" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-primary" id="addBtn">保存</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function updateUser(){
    	...
    	var url="${webRoot}/userInfo/update";
    	var data={
    			id:$("#id").val(),
    			ucName:$("#ucName").val(),
    			user:{
