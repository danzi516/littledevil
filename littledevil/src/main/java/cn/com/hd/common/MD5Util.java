...
public class MD5Util {  
     ...
     * @throws IOException 
     */  
    public static String getFileMD5StringByFile(File file) throws IOException {         
        InputStream fis;  
    ...
    public static String getFileMD5String1ByInp(InputStream fis) throws IOException { 
        byte[] buffer = new byte[1024];  
        int numRead = 0;  
        while ((numRead = fis.read(buffer)) > 0) {  
            messagedigest.update(buffer, 0, numRead);  
    ...
    public static void main(String[] args) throws IOException {  
        ...
        String md5 = getFileMD5StringByFile(file);  
